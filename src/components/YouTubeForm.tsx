...
export const YouTubeForm = () => {
  ...
  const { register, control, handleSubmit, formState: { errors, isDirty, isValid, isSubmitting, isSubmitSuccessful }, watch, getValues, setValue, reset, trigger } = form
  ...
  return (
    <section className="flex flex-col items-center mt-6">
      ...
      <section className="flex items-center border-2 border-sky-400 rounded-2xl mt-6 p-4 min-w-52 md:w-1/2">
        <h2 id="watch-entire-form-values" className="break-words max-w-[90vw] md:max-w-full"></h2>
      </section>
